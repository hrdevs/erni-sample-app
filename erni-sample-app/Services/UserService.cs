...
namespace ernisampleapp.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService()
        {
            ...
            _userModels = new ObservableCollection<UserModel>();
        }

        //public async Task<List<UserModel>> GetUsers()
        //{
        //    Console.WriteLine("GetUsersService");
        ...
        //            _userModels = JsonConvert.DeserializeObject<List<UserModel>>(response.ToString());
        //        }
        //        else
        //        {
        ...
        public async Task<ObservableCollection<UserModel>> GetUsers()
        {
            ...
            try
            {
                if (request.IsSuccessStatusCode)
                {
                    ...
                    _userModels = JsonConvert.DeserializeObject<ObservableCollection<UserModel>>(response.ToString());
                }
                else
                {
                    Console.WriteLine("Get users failed");
